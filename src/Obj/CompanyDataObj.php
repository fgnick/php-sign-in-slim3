...
class CompanyDataObj implements ObjInterface
{
        ...
        if ( property_exists($this, $key) ) {
            ...
            switch ($key) {
                case 'uid': // it cannot be NULL
                    if (is_string($value) && ValueValidate::is_company_uid($value)) {
                        return true;
                    }
                    return false;
                case 'name':
                    if (is_string($value) && ValueValidate::is_company_name($value)) {
                        return true;
                    }
                    return false;
                case 'owner':
                    if ( $value instanceof UserDataObj ) {
                        return true;
                    }
                    return false;
                case 'status':
                    if (is_int($value) && ValueValidate::is_company_status($value)) {
                        return true;
                    }
                    return false;
                case 'create_on':
