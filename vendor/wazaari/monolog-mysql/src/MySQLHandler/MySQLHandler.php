...
class MySQLHandler extends AbstractProcessingHandler
{
    ...
    /**
     * NOTE: ***** PS. This API is rebuild by Nick Feng at Jan.30th in 2018. *****
     *
     * id, channel, level, message, time, url, ip, http_method, server, referrer
     * @var array default fields that are stored in db
     */
    //private $defaultfields = array('id', 'channel', 'level', 'message', 'time', 'url', 'ip', 'http_method', 'server', 'referrer');
    ...
    protected function write(array $record): void
    {
        ...
        $tz = new \DateTimeZone('UTC'); // modified by nick feng.
